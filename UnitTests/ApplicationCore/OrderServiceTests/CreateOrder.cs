...
namespace UnitTests.ApplicationCore.OrderServiceTests
{
    public class CreateOrder
    {
        ...
        public readonly Adress _demoAdress = new Adress()
        {
            City = "London",
            Country ="UK",
            Street ="2221B Baker ",
        ...
        public async Task ShouldThrowEmptyBasketExceptionIfBasketIsEmpty()
        {
            ...
            await Assert.ThrowsAsync<EmptyBasketException>(async () => await orderService.CreateOrderAsync(_demoBuyerId, _demoAdress));

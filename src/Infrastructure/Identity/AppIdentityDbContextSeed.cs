...
namespace Infrastructure.Identity
{
    public static class AppIdentityDbContextSeed
    {
        ...
        {
            if (!await roleManager.RoleExistsAsync(Authorization.Roles.ADMINISTATOR))
                await roleManager.CreateAsync(new IdentityRole(Authorization.Roles.ADMINISTATOR));
            ...
            if (!await userManager.Users.AnyAsync(x=>x.UserName ==Authorization.DEFAULT_ADMIN_EMAIL))
            {
                ...
                await userManager.AddToRoleAsync(adminUser,Authorization.Roles.ADMINISTATOR);
            }
            ...
            //await userManager.AddToRoleAsync(demoUser, Authorization.Roles.ADMINISTATOR);
            }
